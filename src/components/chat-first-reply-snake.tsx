...
export function ChatFirstReplySnake() {
  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-1 flex-col bg-[#0b0a08]">
      <div className="shrink-0 border-b border-white/[0.06] px-3 py-2 text-center">
        ...
        <p className="mt-0.5 text-xs text-zinc-500">
          Play while Foundry finishes the first reply — nothing’s frozen.
        </p>
      </div>
      <div
        ref={wrapRef}
      ...
      >
        <canvas
          ref={canvasRef}
          className="shrink-0"
          aria-label="Snake — use arrow keys while Foundry responds"
