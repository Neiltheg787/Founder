      ...
      {!hideFloatingArButton ? (
        <div className="pointer-events-auto absolute right-3 top-[min(22%,160px)] z-[35] flex max-w-[11rem] flex-col items-end gap-2">
          <button
            ...
            className="rounded-full bg-amber-500 px-3 py-2 text-center text-[11px] font-bold leading-tight text-amber-950 shadow-lg disabled:opacity-50"
          >
    ...
    >
      ...
      <div className="flex flex-wrap justify-center gap-2">
        <button
          ...
          className="rounded-full bg-amber-500 px-4 py-2.5 text-sm font-semibold text-amber-950 disabled:opacity-40"
        >
          Pin model
        </button>
        <button
      ...
      {!session ? (
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-4 bg-black/75 px-6 text-center">
          ...
          <button
            ...
            className="rounded-full bg-amber-500 px-5 py-3 text-sm font-semibold text-amber-950"
          >
            Enter AR
          </button>
        </div>
