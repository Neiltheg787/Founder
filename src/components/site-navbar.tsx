...
function SiteNavbarInner() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/[0.08] bg-[#0b0a08]/95 pt-[env(safe-area-inset-top)]">
      <nav
        aria-label="Main"
        className={cn(
            ...
            <Dialog.Root>
              ...
              <Dialog.Portal>
                ...
                >
                  ...
                  Foundry turns descriptions into real hardware work:
                  ...
                  <div className="mt-5 space-y-4 text-left text-sm leading-relaxed text-white/75 md:text-[0.9375rem]">
                    <p>
                      <strong className="font-medium text-white/95">Foundry</strong>{" "}
