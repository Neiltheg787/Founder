...
export function RetrowaveWorkspace() {
  ...
  return (
    <div className="relative flex min-h-0 w-full flex-1 flex-col bg-[#0b0a08] text-zinc-100">
      <div
        className={cn(
      ...
      >
        ...
        {activeId && activeProject ? (
          <header className="sticky top-0 z-[38] shrink-0 overflow-visible border-b border-white/[0.06] bg-[#0b0a08] px-4 py-2.5 sm:px-6 md:px-8">
        ...
        <main
          className={cn(
            "relative z-10 flex min-w-0 flex-col bg-[#0b0a08]",
            activeId
          ...
          {activeId ? (
            ...
            >
              <motion.aside
                ...
                className={cn(
                  "relative flex min-h-0 w-full flex-col border-white/[0.08] bg-[#0b0a08]",
              ...
              >
                      ...
                      >
                        <div className="max-w-[min(100%,18rem)] rounded-2xl border border-zinc-800 bg-zinc-900/85 px-3 py-2">
                          <p className="text-[13px] leading-relaxed text-zinc-200">
                            Foundry is drafting your updates
                ...
                <div className="shrink-0 border-t border-zinc-800/90 bg-[#0b0a08] p-2 sm:p-2.5">
                  {assistantDrafting ? (
              ...
              <motion.section
                ...
                className="flex min-h-0 min-w-0 flex-1 flex-col bg-[#0b0a08]"
              >
                {awaitingFirstAssistant ? (
                  <ChatFirstReplySnake />
                ) : (
                  <>
                <div className="shrink-0 border-b border-white/[0.06] bg-[#0b0a08] px-3 py-2.5 sm:px-4">
                  <ProjectToolDock
      ...
      {!activeId ? (
        <>
          <div
            aria-hidden
            className="pointer-events-none fixed inset-x-0 bottom-0 z-30 h-28 bg-gradient-to-t from-[#0b0a08] via-[#0b0a08]/72 to-transparent"
          />
