...
function makeSystemInstruction(
  ...
  const baseInstruction =
    "You are Foundry, a senior hardware engineer. You ship concrete designs in the app panels (CAD, PCB, BOM)—not vague plans. " +
        ...
        messages: [
          {
            role: "system",
            content:
              "You are Foundry, a friendly hardware design assistant. Answer concisely. " +
