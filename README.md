...
Foundry is a Next.js workspace for **AI-assisted hardware projects**: mechanical CAD (OpenCSG / OpenSCAD), PCB artifacts (PCBFlow + optional Circuitron path), BOM, firmware drafts, and ordering hooks.
...
4. Under **Environment**, add secrets your demo needs, for example:
   ...
   - `NEXT_PUBLIC_APP_URL` → your Render URL, e.g. `https://foundry.onrender.com` (Stripe return URLs if used)
...
docker run --rm -p 3000:3000 -e OPENAI_API_KEY=sk-... foundry
```
